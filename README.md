...
5. If you are running WordPress version less than 4.7, you will need to install the [JSON REST API](https://wordpress.org/plugins/rest-api/). Also, make sure you have proper permalinks set up.
